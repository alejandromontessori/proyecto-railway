...
<head>
    <meta charset="UTF-8">
    <title>Usuario (Admin) — {{ $user->apodo }}</title>
    <style>
        :root{
            --ink:#0e1a18;
            --muted:#5b6f6d;
...
<div class="wrapper">
    ...
    <h1 class="title">Usuario (Admin) — {{ $user->apodo }}</h1>
    ...
    <div class="row" style="margin-top:12px">
        ...
        <a class="btn secondary" href="{{ route('ad.usuarios') }}">← Volver a Usuarios</a>
    </div>
</div>
